...
<template>
  <div class="card">
    ...
    <div class="controls">
      <button class="btn btn-ghost" @click="router.push('/my')">Мои курсы</button>
    </div>
      ...
      >
        <div class="catalog-card__top">
          <div class="catalog-card__icon-shell">
            <img :src="projectImage(project)" :alt="project.title" loading="lazy" />
          </div>
        </div>
...
.catalog-card {
  ...
  box-shadow: 0 14px 38px rgba(0, 0, 0, 0.42), inset 0 1px 0 rgba(255, 255, 255, 0.22),
...
.catalog-card__icon-shell {
  ...
  justify-content: center;
  overflow: hidden;
  box-shadow: 0 18px 34px rgba(0, 0, 0, 0.38), inset 0 1px 0 rgba(255, 255, 255, 0.85),
